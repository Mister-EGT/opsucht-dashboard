...
export function MerchantDashboard() {
  ...
  return (
    <>
      <PageHeader eyebrow="OPShards" title="Händler und Wechselkurse" description="Aktuelle Rohstoffhändler-Kurse und Custom-Items mit passenden Item-Icons." actions={<><DataFreshness meta={ratesQuery.data?.meta} fetching={ratesQuery.isFetching} /><RefreshButton fetching={ratesQuery.isFetching} onRefresh={() => { ratesQuery.refetch(); }} /></>} />
