...
const OVERVIEW_SECTIONS: ScrollProgressSection[] = [
  { id: "overview-start", label: "Überblick" },
  { id: "overview-kpis", label: "Kennzahlen" },
  { id: "overview-market", label: "Markt & Auktionen" },
  { id: "overview-prices", label: "Preise & Favoriten" },
];
